...
const PRODUCT_STEPS = ["6W", "ARTISTRY", "ESPRING", "HOUSEHOLD", "SKY", "DETOX", "BREAKFAST SET"];
        ...
        {showSearch && (
          ...
          >
            <div className="relative flex items-center">
              <Search size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-400 pointer-events-none z-10" />
              <input
                type="text"
